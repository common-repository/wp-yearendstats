...
1. The above screenshot shows the "Number of Posts by year" graph.


2. The above screenshot shows the "Number of Comments by year" graph.


3. The above screenshot shows the "Average length of posts by year" graph.


4. The above screenshot shows the "Total length of posts by year" graph.
